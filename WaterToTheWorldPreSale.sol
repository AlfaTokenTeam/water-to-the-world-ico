...
import "./WaterToTheWorld.sol";

contract WaterToTheWorldPreSale {
    WaterToTheWorld public token;
    ...
    function WaterToTheWorldPreSale(
        WaterToTheWorld _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = WaterToTheWorld(_token);
